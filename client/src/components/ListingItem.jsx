  ...
  return (
    <div className='bg-white shadow-md hover:shadow-xl transition-shadow overflow-hidden w-full rounded-lg md:w-[330px]'>
      <Link to={`/listing/${list._id}`}>
        ...
        {list.imageUrls ? ( <img src={list.imageUrls[0]} alt='listing cover' className='h-[320px] md:h-[220px] w-full object-cover hover:scale-105 transition-scale duration-300' /> ): ''}
